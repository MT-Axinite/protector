...
minetest.register_node("protector:protect", {
	...
	drawtype = "nodebox",
	tiles = {
		"moreblocks_circle_stone.png",
		"moreblocks_circle_stone.png",
		"protec.png^protector_logo.png"
	},
...
minetest.register_craft({
	...
	recipe = {
		{"default:stone", "default:tinblock", "default:stone"},
...
--	description = S("Protection PvP"),
--	drawtype = "nodebox",
--	tiles = {
--		"moreblocks_circle_stone.png",
--		"moreblocks_circle_stone.png",
--		"protec_pvp.png^protector_logo.png"
--	},
--	sounds = default.node_sound_stone_defaults(),
--	groups = {dig_immediate = 2, unbreakable = 1},
--	is_ground_content = false,
...
--		{"default:diamond", "protector:protect", "default:diamond"},
--		{"default:diamond", "default:diamond", "default:diamond"},
--	}
--})
