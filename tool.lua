...
minetest.register_craftitem("protector:tool", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if #minetest.find_nodes_in_area(
			...
			{"protector:protect", "protector:protect_pvp"}) > 0 then
		...
		and not inv:contains_item("main", "protector:protect_pvp") then
		...
		elseif inv:contains_item("main", "protector:protect_pvp") then
